...
struct LoanForm: View {
    ...
    @AppStorage("vektor.finance.loan.principal")    private var principal: Double = 300_000
    @AppStorage("vektor.finance.loan.rate")         private var ratePercent: Double = 5.5
    @AppStorage("vektor.finance.loan.term")         private var termYears: Double = 30
    @AppStorage("vektor.finance.loan.currency")     private var currency: String = "USD"
    @AppStorage("vektor.finance.loan.extraMonthly") private var extraMonthly: Double = 0
    ...
    private var chartSection: some View {
        Section("Principal vs interest over time") {
            ...
            .chartForegroundStyleScale([
                "Principal": VektorTheme.accent.opacity(0.6),
                "Interest":  VektorTheme.statusBad.opacity(0.3)
            ])
            .frame(height: 180)
        }
    }

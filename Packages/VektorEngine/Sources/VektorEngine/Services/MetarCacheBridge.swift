...
public final class MetarCacheBridge {
    ...
    public static let notificationName = Notification.Name("vektor.metarCache.updated")
    ...
    private static let logger = Logger(subsystem: "app.vektor.Vektor", category: "metar-cache-bridge")

...
public final class QuoteCacheBridge {
    ...
    public static let notificationName = Notification.Name("vektor.quoteCache.updated")
    ...
    private static let logger = Logger(subsystem: "app.vektor.Vektor", category: "quote-cache-bridge")
